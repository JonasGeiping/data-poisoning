...
Move the file poison_setups_from_scratch.pickle to the folder poisons or change its address to the location on your machine.
The evaluation assumes that a folder called poisoning-benchmark is located on the same level as this framework.
"""
